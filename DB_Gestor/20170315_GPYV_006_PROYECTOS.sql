--------------------------------------------------------
-- Archivo creado  - miércoles-marzo-15-2017   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for View GPYV_006_PROYECTOS
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "GESTOR"."GPYV_006_PROYECTOS" ("A001CODIGO", "A001SIGLA", "A002CODIGO", "A002NOMBRPROYCT","A001NOMBRE", "TIPOPROYECTO", "A002TIPPROYCT", "A002DESCRPCINPROYCT", "IDESTADOPROYECTO", "ESTADOPROYECTO", "A002IDUSR", "A055IDPUBLICADOR", "A002ESTADOREGISTRO", "A002FECHACREACION") AS 
  SELECT A001CODIGO,
    A001SIGLA, 
    A002CODIGO,
    A002NOMBRPROYCT,
