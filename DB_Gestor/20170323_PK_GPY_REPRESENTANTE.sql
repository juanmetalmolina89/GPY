create or replace PACKAGE BODY          "PK_GPY_REPRESENTANTE" is
  ...
  PROCEDURE Pr_RegistrarRepresentante (p_IdPersonaJuridica IN GPYT_T052_PERSONA.A052CODIGO%TYPE,
    ...
    BEGIN   
    -- ficasa:
    -- primero verifique si el p_A052NUMRDOCMNT no existe. Solo en ese caso debe insertar.
    ...
    IF p_A052CODIGO IS NULL THEN
      ...
      FETCH p_Respuesta INTO codPersona;     
    ELSE
      codPersona := p_A052CODIGO; 
    END IF;
    
      

      PK_T053_REPLEGAL.Pr_Insertar (p_A053IDPERSONAJURD => p_IdPersonaJuridica,
                                    p_A053IDREPRESENTANTE => codPersona,
