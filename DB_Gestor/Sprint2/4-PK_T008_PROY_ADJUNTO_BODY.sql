   ...
   BEGIN
      ...
      IF p_Filtro IS NULL THEN
         OPEN p_resultado FOR
           SELECT * FROM GPYT_T008_PROY_ADJUNTO WHERE A008ESTADOREGISTRO = PK_UTL_CONSTANTE.COD_ACTIVO;  
      ...
      strSQL := 'SELECT * FROM GPYT_T008_PROY_ADJUNTO WHERE ' || p_Filtro  || p_Temp;
