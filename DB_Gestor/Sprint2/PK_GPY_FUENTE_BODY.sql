...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Package Body PK_GPY_FUENTE
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "GESTOR"."PK_GPY_FUENTE" 
AS
  ...
  BEGIN
    ...
    --
    PK_T038_FUENTE.PR_INSERTAR( P_A038NOMBRFUNT => P_A038NOMBRFUNT, P_A038IDPROYECTO => P_A038IDPROYECTO, P_A038IDDESGRCATIPCC => P_A038IDDESGRCATIPCC, P_A038FACTOREMISION => P_A038FACTOREMISION, P_IDUSUARIO => P_IDUSUARIO, P_RESULTADO => P_RESULTADO, P_CODERROR => P_CODERROR, P_MSJERROR => P_MSJERROR );
    --
...
----****
  ...
  BEGIN
    ...
    --
    PK_T038_FUENTE.PR_ACTUALIZAR( P_A038CODIGO => P_A038CODIGO, P_A038NOMBRFUNT => P_A038NOMBRFUNT, P_A038IDPROYECTO => P_A038IDPROYECTO, P_A038IDDESGRCATIPCC => P_A038IDDESGRCATIPCC, P_A038FACTOREMISION => P_A038FACTOREMISION, P_IDUSUARIO => P_IDUSUARIO, P_RESULTADO => P_RESULTADO, P_CODERROR => P_CODERROR, P_MSJERROR => P_MSJERROR );
    --
