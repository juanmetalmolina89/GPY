...
---***
  ...
  BEGIN
    ...
    END IF;
    --
    OPEN p_resultado FOR SELECT * FROM GPYV_009_POLITICAPROYECTO FUE WHERE FUE.A007IDPROYECTO = p_A007IDPROYECTO AND FUE.A026ESTADOREGISTRO = PK_UTL_CONSTANTE.COD_ACTIVO;
