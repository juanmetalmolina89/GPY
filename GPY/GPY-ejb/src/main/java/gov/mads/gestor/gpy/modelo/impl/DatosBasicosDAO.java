...
public class DatosBasicosDAO extends GenericoDAO{
    ...
    public ObjetoSalida registrarProyecto(RegistrarProyectoOE objetoEntrada) {
        ...
        try {
            ...
            parametros.add(new SentenciaParametroDAO("p_A002COSTSESTMDTOTL", objetoEntrada.getProyecto().getA002costsestmdtotl(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
            parametros.add(new SentenciaParametroDAO("p_A002COSTSESTMDFORMLCN", objetoEntrada.getProyecto().getA002costsestmdformlcn(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
            parametros.add(new SentenciaParametroDAO("p_A002COSTTONLDRDCR", objetoEntrada.getProyecto().getA002costtonldrdcr(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
            parametros.add(new SentenciaParametroDAO("p_A002TRM", objetoEntrada.getProyecto().getA002trm(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
