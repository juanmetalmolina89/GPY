...
public class PoliticaDAO extends GenericoDAO { 
        ...
        public ObjetoSalida consultarAdjuntoPol(ConsultarAdjuntoPolOE objetoEntrada){
                
		ObjetoSalida objetoSalida = new ObjetoSalida();

                try {

                    SentenciaDAO sentencia = new SentenciaDAO("PK_T026_ARCHIVO.Pr_ConsultarPorFiltro", objetoEntrada.getIdUsuario());
                    List<SentenciaParametroDAO> parametros = new ArrayList<SentenciaParametroDAO>();
                    //parametros.add(new SentenciaParametroDAO("p_A003CODIGO", objetoEntrada.getA003codigo(), SentenciaTipoParametroDAO.ENTRADA, OracleTypes.NUMBER));
