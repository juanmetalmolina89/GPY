 ...
 */
@XmlRootElement
public class RegistrarProyectoOE extends ObjetoEntrada {
    ...
    @XmlElement    
    public float A002POTNCLESTMDREDCCN;
    
    public float getA002POTNCLESTMDREDCCN() {
        return A002POTNCLESTMDREDCCN;
    }

    public void setA002POTNCLESTMDREDCCN(float A002POTNCLESTMDREDCCN) {
