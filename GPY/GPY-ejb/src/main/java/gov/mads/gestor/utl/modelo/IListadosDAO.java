...
public interface IListadosDAO {
    ...
    ObjetoSalida listarPoliticas(ListarPoliticasOE OE);
    ObjetoSalida listarPlanes(ListarPlanesOE OE);
    ObjetoSalida listarEstrategias(ListarEstrategiasOE OE);
    ObjetoSalida listarProgramas(ListarProgramasOE OE);
